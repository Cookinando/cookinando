  ...
  const handleDeleteAccount = async () => {
    const result = await Swal.fire({
      ...
      customClass: {
        ...
        confirmButton: "bg-light-dark hover:bg-green-600 text-white font-semibold py-2 px-4 rounded mr-2", 
        cancelButton: "bg-gray-400 hover:bg-gray-500 text-white font-semibold py-2 px-4 rounded", 
      },
