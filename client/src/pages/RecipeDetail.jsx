...
const RecipeDetail = () => {
  ...
  return (
    <div className="w-5/6 mx-auto">
      <h2 className="text-light-dark font-semibold text-7xl text-center my-6 max-md:text-6xl">
        {post.title}
      </h2>
      <div
        className={`bg-light text-dark ${
          post.imageUrl ? "mt-80" : "mt-20"
      ...
      >
        ...
        <div className="px-52 mx-auto mt-10 max-lg:px-20">
          <h3 className="text-4xl my-8 max-md:text-3xl">
